export const PT_BR = {
   ...
   AbuSimbelDesc: "Dobra o efeito de Ramesses II. Todas as maravailahs adjacentes recebem +1 de Felicidade",
   ...
   AccountLevelUpgradeConditionAnyHTML: "Para subir o nível da sua conta, você só precisa satisfazer <b>um dos seguintes</b> critérios:",
   ...
   AlanTuringDesc: "+%{value} Ciência de Trabalhadores Ociosos",
   ...
   AntiCheatFailure: "O ranque da sua conta foi restringido devido a <b>não passar na checagem anti-trapaça</b>. Entre em contato com o desenvolvedor se quiser contestar essa decisão",
   ...
   ApplyToBuildingInTile: "Aplicar A Todos(as) %{building} em até %{tile} Espaços",
   ApplyToBuildingsToastHTML: "Aplicado a <b>%{count} %{building}</b> com sucesso",
   Aqueduct: "Aqueduto",
   ...
   AtomicFacility: "Instalaçõa Atômica",
   AtomicTheory: "Teoria Atômica",
   Atomium: "Atomium",
   AtomiumDescV2: "All buildings that produce science within 2 tile range get +5 Production Multiplier. Generate science that is equal to the Produção De Ciência within 2 tile range. When completed, generate one-time science equivalent to the cost of the most expensive unlocked technology",
   Autocracy: "Autocracia",
   Aviation: "Aviação",
   BackToCity: "Voltar para a Cidade",
   BackupRecovery: "Restaurar Backup",
   Bakery: "Padaria",
   ...
   BatchModeTooltip: "%{count} construções selecionadas. Aprimoramento será aplicado a todas as construç~eos selecioandas",
   BatchSelectAllSameType: "Todos(as) do mesmo tipo",
   BatchSelectAnyType1Tile: "Qualquer Tipo em até 1 Espaço",
   BatchSelectAnyType2Tile: "Qualquer Tipo em até 2 Espaço",
   BatchSelectAnyType3Tile: "Qualquer Tipo em até 3 Espaço",
   BatchSelectSameType1Tile: "Mesmo Tipo em até 1 Espaço",
   BatchSelectSameType2Tile: "Mesmo Tipo em até 2 Espaço",
   BatchSelectSameType3Tile: "Mesmo Tipo em até 3 Espaço",
   BatchSelectThisBuilding: "Essa Construção",
   BatchUpgrade: "Aprimoramento de Lote",
   Battleship: "Navio de Guerra",
   BattleshipBuilder: "Construtor de Navio de Guerra",
   Beijing: "Pequim",
   Biplane: "Biplano",
   ...
   BuildingDefaults: "Padrão da Construção",
   BuildingDefaultsCount: "%{count} propriedades substituídas pelo padrão da construção",
   BuildingDefaultsRemove: "Limpar todas as substituições de propriedades",
   BuildingEmpireValue: "Valor de Império da Construção / Valor de Império do Recurso",
   BuildingMultipliers: "Incremento",
   BuildingName: "Nome",
   BuildingNoMultiplier: "%{building} <b>não é afetada</b> por nenhum multiplicador (produção, capacidade de trabalhador, armazenamento, etc)",
   ...
   CarlFriedrichGaussDesc: "+%{idle} de Ciência de Trabalhadores Ociosos. +%{busy} de Ciência de Trabalhadores Ocupados",
   Cathedral: "Catedral",
   Census: "Censo",
   ...
   ChooseGreatPersonChoicesLeft: "Você possui %{count} escolhas restantes",
   Church: "Igreja",
   ...
   Culture: "Cultura",
   CurrentLanguage: "Português (BR)",
   CursorBigOldFashioned: "3D (Big)",
   CursorOldFashioned: "3D",
   CursorStyle: "Estilo de Cursor",
   CursorStyleDescHTML: "Muda o estilo do cursos. <b>Requer reiniciar o jogo para fazer efeito</b>",
   ...
   ElectrificationPowerRequired: "Energia Necessária",
   ElectrificationStatusActive: "Ativa",
   ElectrificationStatusDesc: "Tanto construções que necessitam de energia, quanto as que não necessitam, podem ser eletrificadas. No entanto, construções que necessitam de energia produzem uma eficiência elétrica maior",
   ElectrificationStatusNoPowerV2: "Energia Insufciente",
   ElectrificationStatusNotActive: "Inativo(a)",
   ElectrificationStatusV2: "Estado da Eletrificação",
   ...
   EmpireValueFromBuilding: "Valor do Império de Construção",
   EmpireValueFromBuildingsStat: "De Construções",
   ...
   ExtraTileInfoType: "Informações do Espaço Extra",
   ExtraTileInfoTypeDesc: "Escolha qual informação é exibida abaixo de cada espaço",
   ExtraTileInfoTypeEmpireValue: "Valor do Império",
   ExtraTileInfoTypeNone: "None",
   ExtraTileInfoTypeStoragePercentage: "Porcentagem do Armazenamento",
   Faith: "Fé",
   Farming: "Cultivo",
   FavoriteBuildingAdd: "Adicionar a Favoritos",
   FavoriteBuildingEmptyToast: "Você não possui nenhuma cosntrução favoritada",
   FavoriteBuildingRemove: "Remover dos Favoritos",
   Feudalism: "Feudalismo",
   Fibonacci: "Fibonacci",
   FibonacciDescV2: "+%{idle} de Ciência de Trabalhadores Ociosos. +%{busy} Science from Busy Workers. Fibonacci's permanent upgrade cost follows Fibonacci sequence",
   FighterJet: "Caça",
   FighterJetPlant: "Fábrica de Caças",
   ...
   FontSizeScale: "Escala do Tamanho da Fonte",
   ...
   FrankLloydWrightDesc: "+%{value} Multiplicador De Capacidade De Construtor",
   FrankWhittle: "Frank Whittle",
   FreeThisWeek: "Grátis nessa Semana",
   FreeThisWeekDescHTML: "<b>A cada semana</b>, uma das cidades premium se torna gratuita para jogar. A cidade grátis dessa semana é <b>%{city}</b>",
   Frigate: "Fragata",
   FrigateBuilder: "Construtor de Fragatas",
   Furniture: "Móvel",
   FurnitureWorkshop: "Oficina de Móveis",
   GalileoGalilei: "Galileo Galilei",
   GalileoGalileiDesc: "+%{value} Ciência de Trabalhadores Ociosos",
   Galleon: "Galeão",
   ...
   Glass: "Vidro",
   Glassworks: "Vidraria",
   GlobalBuildingDefault: "Padrão Global de Construção",
   ...
   GreatPersonLevelRequired: "Nível de Figuras Históricas Permanentes Necessário",
   GreatPersonLevelRequiredDesc: "Renascer em %{city} requer %{required} níveis de figuras históricas permanentes. Atualmente, você possui %{current}",
   GreatPersonOnlyIn: "Essa figura histórica nasce apenas em %{city}",
   GreatPersonPromotionPromote: "Promover",
   GreatPersonThisRunEffectiveLevel: "Atualmente, você possui %{count} %{person} nessa tentativa. Uma %{person} adicional terá 1/%{effect} do efeito",
   ...
   IMPei: "I. M. Pei",
   IMPeiDesc: "+%{value} Multiplicador De Capacidade De Construtor",
   ...
   IsidoreOfMiletusDesc: "+%{value} Multiplicador De Capacidade De Construtor",
   ...
   LouisSullivanDesc: "+%{value} Multiplicador De Capacidade De Construtor",
   Lumber: "Lenha",
   LumberMill: "Serraria",
   ...
   MarketRefreshMessage: "Trocas em %{count} mercados foram atualizadas",
   MarketSell: "Vender",
   ...
   MaxExplorers: "Máximo de Exploradores",
   ...
   SidePanelWidthDescHTML: "Change the width of the side panel. <b>Requer reiniciar o jogo para fazer efeito</b>",
   ...
   StatisticsScienceFromBuildings: "Ciência De Construções",
   StatisticsScienceFromWorkers: "Ciência De Trabalhadores",
   StatisticsScienceProduction: "Produção De Ciência",
   ...
   TajMahal: "Taj Mahal",
   TajMahalDescV2: "A great person of Classical Age and a great person of Middle Age are born. +5 Multiplicador De Capacidade De Construtor when upgrading buildings over Level 20",
   ...
   UseMirrorServerDescHTML: "If you have problems accessing the main server, you can connect to the mirror server instead. <b>Requer reiniciar o jogo para fazer efeito</b>",
